...
export const Header: React.FC<Props> = ({ project }) => {
	...
	return (
		...
		>
			<div
				className={`fixed inset-x-0 top-0 z-50 backdrop-blur lg:backdrop-blur-none duration-200 border-b lg:bg-transparent ${
					isIntersecting
						...
						: "bg-white/70 border-zinc-200 lg:border-transparent"
				}`}
			>
				<div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
					<div className="flex justify-between gap-8">
						<Link target="_blank" href="https://www.linkedin.com/in/ella-r-hansen/">
							<Linkedin
						...
						<Link target="_blank" href="https://www.instagram.com/_ella.hansen/">
							<Instagram
								className={`w-6 h-6 duration-200 hover:font-medium ${
									isIntersecting
										? " text-black hover:text-black"
			...
			<div className="container mx-auto relative isolate overflow-hidden py-8 sm:py-12">
